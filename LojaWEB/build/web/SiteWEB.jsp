    ...
    <body>
        ...
        <div class="w3-top">
            <div class="w3-bar w3-black w3-card-2">
                ...
                <%HttpSession ses = request.getSession(true);
                    ...
                    Boolean usuarioLogado
                            = (Boolean) ses.getAttribute("usuarioLogado");
                ...
                <div class="w3-dropdown-hover w3-hide-small w3-right">
                    ...
                    <div class="w3-dropdown-content w3-bar-block w3-card-4">
                        <a href="" class="w3-bar-item w3-button">Gerenciar Mensagens</a>
            ...
            <footer class="w3-container w3-padding-64 w3-center w3-opacity w3-light-grey w3-xlarge">
                ...
                <!-- Seção de Login -->
                <%if ((administradorLogado != null) && (administradorLogado == true) && (usuarioLogado != null) && (usuarioLogado == true)) {
                    } else {
                %>
                <div class="w3-container w3-content w3-padding-64 w3-center" style="max-width:800px" id="login">
                    <h2 class="w3-wide ">Login</h2>
                    <p class="w3-opacity "><i>Faça seu login aqui!</i></p>
                    <div class="w3-row  " style="margin:0 0 0 0">
                        <div class="w3-col m6 " style="margin:25%">
                            <form action="controlador">
                                <input type="hidden" name="operacao" value="loginUsuario">
                                <div class="w3-row-padding " style="margin:0 0 0 0">
                                    ...
                                    <button  class="w3-button w3-black w3-section w3-center " type="submit" value="Login">Entrar</button>

                                </div>
                            </form>
                            <div><a
                                    <button  class="w3-button w3-black w3-section w3-center " href="CadastroUsuario.jsp" >Cadastrar</button> </a>
                            </div>
                        </div>
                    </div>
                </div>
